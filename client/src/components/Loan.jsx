    ...
    <div className="flex">
      ...
      <div className="p-5 bg-gray-500/20 w-full">
        ...
        <div className="flex gap-3 flex-wrap mt-10 w-full">
          <div className="bg-white w-60 flex gap-3 items-center shadow-2xl grow-1">
          ...
          <div className="bg-white flex w-60 gap-3 items-center shadow-2xl grow-1">
            <div className="bg-[#0A512F] p-4">
        ...
        <div className="h-[600px] w-full bg-white p-5 mt-5 rounded">
          ...
          <table className="md:table-auto table-fixed w-full">
            <thead className="text-gray-900 border-b border-gray-500/20 text-sm text-left">
              <tr>
                <th className="px-4 py-3 font-semibold truncate text-gray-400">
